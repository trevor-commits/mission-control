...
## Roles
- Claude Cowork: orchestrator and state-move gatekeeper. Claude Code: line-by-line auditor. Codex: implementor. Trevor: decision owner.

## Codex Handoff
Name the Work Record entry, the Completed index entry, any issue creation or ledger refresh, and the Ripple Check and Self-audit attestation expected. Unfinished work: `/loose-ends`.
