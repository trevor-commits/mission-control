...
- [ ] 4.16 Run the authoritative full gate on the final repository convergence head, publish and pass hosted CI, merge the convergence PR, install the merged source, then archive PR #11 and its source branch only after exact containment and recovery-tag readback.
