...
- [ ] 4.20 Exact records head `7a2ae1a` passes the authoritative verifier. Commit this receipt, pass its push hook, obtain green hosted CI and review readback, merge PR #16, install the merged source, then archive PR #11 and its source branch only after exact containment and recovery-tag readback.
