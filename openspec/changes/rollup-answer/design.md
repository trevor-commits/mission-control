...
| Same-day brief is already delivered | Local `NEEDS YOU` view changes while delivery receipt, cursor, identity, and state remain unchanged; no resend occurs |
