...
3. Kill the cluster cards section entirely (Map owns relationships now). Kill unexplained chips: "live" becomes "● active now" with tooltip "used in the last 30 minutes"; provider chip gets a tooltip "which AI this chat ran on"; "76 new today" becomes "76 chats recorded today (across all your AIs)".
